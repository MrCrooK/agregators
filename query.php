...
$query = "insert into nbki values(0,".$_REQUEST['numid'].",'".addslashes($tableOK)."','".addslashes($tableVK)."','".addslashes($tableNBKI)."','".addslashes($fssprus)."','".addslashes($tableEXPERT)."','".$pasportvalid."',1,1)"; 
